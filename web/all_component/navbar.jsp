...
<div class="container-fluid p-3">
    <div class="row">
     ...
     <div class="col-md-6">
        ...
        <div class="col-md-3 "> 
            <a href="cart.jsp" style="position: relative;top:10px; right: 5px;"><i class="fa-solid fa-cart-plus fa-2x"></i></a>
            <a href="Login.jsp"class="btn btn-success "><i class="fa-solid fa-right-to-bracket"></i> ${userobj.name}</a> 
            <a href="Logout"class="btn btn-primary "><i class="fa-solid fa-user-plus"></i> Logout</a>
        </div> 
        </c:if>
